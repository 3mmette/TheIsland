...
fruit_tree._reveals_item.append(red_fruit)
...
yellow_fruit = Consumable(7, False, 6, 0,
                          ...
                          "Sweet and delicious.")
fruit_tree._reveals_item.append(yellow_fruit)
...
blue_fruit = Consumable(7, False, 6, 0,
                        ...
                        "Sweet and delicious.")
fruit_tree._reveals_item.append(blue_fruit)
...
fruit_tree._reveals_item.append(green_fruit)
...
orange_fruit = Consumable(7, False, -5, -5,
                          ...
                          "It makes you sick.")
fruit_tree._reveals_item.append(orange_fruit)
...
purple_fruit = Consumable(7, False, -5, -5,
                          ...
                          "It makes you sick.")
fruit_tree._reveals_item.append(purple_fruit)
